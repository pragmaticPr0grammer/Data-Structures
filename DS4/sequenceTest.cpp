...
template <typename T>
void show_list(sequenceSpace::sequence <T> src)
{
...
int main(int argc, char *argv[])
{
   ...
   sequenceSpace::sequence<double> s1;  // A sequence of double for testing
   sequenceSpace::sequence<char> s2; // A sequence of char for testing
